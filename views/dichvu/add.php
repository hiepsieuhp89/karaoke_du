<?php
    ...
    if(isset($_POST["addForm"])){
        ...
        $status = is_numeric($form["maDichVu"]);
        if(!$status){
            ...
            <p>kiểm tra lại mã dịch vụ (định dạng số)</p>
            </div>';
        }else{
            $DichVu = new DichVu();

            $status = $DichVu->ThemDichVu(
                $form["maDichVu"],
                $form["tenDichVu"],
                $form["moTa"],
                $form["donGia"],
            ...
            if(!$status){
                ...
                header("Location: index.php?controller=dichvu&action=index"); 
                exit();
            }
        }
    }
                    ...
                    <div class="form-group  ">
                      ...
                      <div class="col-sm-8">
                        <div class="input-group">
                          ...
                          <input required type="text" id="username" name="addForm[maDichVu]" value="" class="form-control username" placeholder="Nhập mã dịch vụ">
                        </div>
                      </div>
                    </div>
                    <div class="form-group  ">
                      ...
                      <div class="col-sm-8">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-pencil fa-fw" aria-hidden="true"></i></span>
                          <input required type="text" id="name" name="addForm[tenDichVu]" value="" class="form-control name" placeholder="Nhập Tên">
                        </div>
                      </div>
                    </div>
                    <div class="form-group  ">
                      ...
                      <div class="col-sm-8">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-pencil fa-fw" aria-hidden="true"></i></span>
                          <textarea required type="text" id="name" name="addForm[moTa]" class="form-control name"></textarea>
                        </div>
                      </div>
                    </div>
                    <div class="form-group  ">
                      ...
                      <div class="col-sm-8">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-pencil fa-fw" aria-hidden="true"></i></span>
                          <input required type="number" min="0" id="name" name="addForm[donGia]" class="form-control name">
                        </div>
                      </div>
                    </div>
                    <div class="form-group  ">
                      ...
                      <div class="col-sm-8">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-pencil fa-fw" aria-hidden="true"></i></span>
                          <input required type="number" min="0" id="name" name="addForm[soLuong]" class="form-control name">
                        </div>
                      </div>
                    </div>
                    <div class="form-group  ">
