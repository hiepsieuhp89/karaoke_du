                    ...
                    <div class="form-group  ">
                      ...
                      <div class="col-sm-8">
                        <div class="input-group">
                          ...
                          <input type="text" id="username" name="addForm[maKhachHang]" value="" class="form-control username" placeholder="Nhập mã khách hàng">
                        </div>
                      </div>
                    </div>
                    <div class="form-group  ">
                      ...
                      <div class="col-sm-8">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-pencil fa-fw" aria-hidden="true"></i></span>
                          <input type="text" id="name" name="addForm[tenKhachHang]" value="" class="form-control name" placeholder="Nhập Tên">
                        </div>
                      </div>
                    </div>
                    <div class="form-group  ">
