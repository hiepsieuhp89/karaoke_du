<?php
    ...
    if(isset($_REQUEST["editForm"])){
        $form = $_POST["editForm"];
        //echo '<script>alert("'.$form['maNhanVien'].'");</script>';
    }
?>
        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Sửa Nhân viên <?php echo $form['IdNhanVien']; ?></h3>
              <div class="box-tools">
              </div>
            </div>
            <!-- /.box-header -->
                  ...
                  <div class="col-md-12">
                    <div class="form-group hidden d-none">
                      ...
                      <div class="col-sm-8">
                        <div class="input-group">
                          ...
                          <input type="text" id="username" name="editForm[IdNhanVien]" class="form-control username" placeholder="Nhập mã Nhân viên" value="<?php echo $form['IdNhanVien']; ?>">
                        </div>
                      </div>
                    </div>
                    <div class="form-group  ">
                      ...
                      <div class="col-sm-8">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-pencil fa-fw" aria-hidden="true"></i></span>
                          <input type="text" id="name" name="editForm[HoTen]" class="form-control name" placeholder="Nhập Tên" value="<?php echo $form['HoTen']; ?>">
                        </div>
                      </div>
                    </div>
                    <div class="form-group  ">
                      ...
                      <div class="col-sm-8">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-pencil fa-fw" aria-hidden="true"></i></span>
                          <input type="text" id="name" name="editForm[Email]" class="form-control name" placeholder="Nhập Tên" value="<?php echo $form['Email']; ?>">
                        </div>
                      </div>
                    </div>
                    <div class="form-group  ">
