<?php
    ...
    if(isset($_POST["deleteForm"])){
        ...
        $maNhanVien = $_POST["deleteForm"]["maNhanVien"];

        $NhanVien = new NhanVien();

        $status = $NhanVien->XoaNhanVien($maNhanVien);
    ...
    if(isset($_REQUEST["searchForm"])){
        ...
        $NhanVien = new NhanVien();
        $NhanViens = $NhanVien->TimKiem($form['maNhanVien'], $form['TenNhanVien'], $form['trangThai']);
    }
    else{
        $NhanVien = new NhanVien();
        $NhanViens = $NhanVien->DanhSachNhanVien();
    }
          ...
          <div class="box grid-box">
            <div class="box-header with-border">
              <div class="pull-right">
                ...
                <a href="index.php?controller=NhanVien&action=add" class="btn btn-sm btn-success" title="Thêm mới">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <div class="input-group input-group-sm">
                              ...
                              <input type="text" class="form-control name" name="searchForm[maNhanVien]" value="<?php echo isset($_POST["searchForm"]) ? $_POST["searchForm"]["maNhanVien"] : '' ?>">
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <div class="input-group input-group-sm">
                              ...
                              <input type="text" class="form-control name" name="searchForm[TenNhanVien]" value="<?php echo isset($_POST["searchForm"]) ? $_POST["searchForm"]["TenNhanVien"] : '' ?>">
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="col-md-8">
                        ...
                        <div class="btn-group pull-left " style="margin-left: 10px;">
                          <a href="index.php?controller=NhanVien&action=index" class="btn btn-default btn-sm"><i class="fa fa-undo"></i>  Reset tìm kiếm</a>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover grid-table" id="grid-table611dfe8fce584">
                <thead>
                  <tr>
                    <th class="column-id">Mã nhân viên<a class="fa fa-fw fa-sort" href="https://truyenthanh.org.vn/auth/users?_pjax=%23pjax-container&amp;_sort%5Bcolumn%5D=id&amp;_sort%5Btype%5D=desc" aria-hidden="true"></a></th>
                ...
                <tbody>
                  <?php
                    foreach($NhanViens as $item){
                        ...
                        <span class="label label-success" style="font-size:12px;">'.$item['HoTen'].'</span>
                        </td>
                        ...
                        <td class="column-__actions__">
                          <div class="grid-dropdown-actions dropdown">
                            ...
                            <form method="post" action="index.php?controller='.$_REQUEST['controller'].'&action=edit">
                                ...
                                <input hidden class="hidden" type="text" name="editForm[HoTen]" value="'.$item['HoTen'].'">
                                <input hidden class="hidden" type="text" name="editForm[Email]" value="'.$item['Email'].'">
                            ...
                            <form method="post" action="">
                                <input hidden class="hidden" type="text" name="deleteForm[maNhanVien]" value="'.$item['IdNhanVien'].'">
